...
const AdminPanel: React.FC = () => {
    ...
    return (
        <>
            <button onClick={handleAdminPanelToggle} className="mt-5 ml-20 hover:cursor-pointer bg-zinc-100 text-gray-600  hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-zinc-100 dark:hover:bg-gray-300 dark:focus:black">
               Show Admin Panel
            </button>
